...
public class AccessToken implements IStorageDirBundle {
    ...
    public JSONObject getContactToken() throws JSONException, CryptoException {
        ...
        jsonObject.put(ACCESS_ENTRY_SIGNATURE_KEY, Base64.encodeToString(getAccessEntrySignature(), 16));
        ...
        jsonObject.put(CONTACT_AUTH_PRIVATE_KEY_KEY, Base64.encodeToString(
                contactAuthKey.getPrivate().getEncoded(), 16));
        return jsonObject;
    }
