...
import org.fejoa.library.crypto.KDFParameters;
...
public class KeyStore extends StorageDirObject {
    ...
    static public class Settings {
        ...
        public Settings(JSONObject config) throws JSONException {
            ...
            iv = Base64.decode(config.getString(Constants.IV_KEY), Base64.DEFAULT);
        ...
        public JSONObject toJson() {
            ...
            try {
                ...
                config.put(Constants.IV_KEY, Base64.encode(iv, Base64.DEFAULT));
    ...
    static public class KDFCrypto {
        ...
        public KDFCrypto(JSONObject jsonObject) throws JSONException {
            ...
            encryptedMasterKey = Base64.decode(jsonObject.getString(MASTER_KEY_KEY), Base64.DEFAULT);
            masterKeyIV = Base64.decode(jsonObject.getString(MASTER_KEY_IV_KEY), Base64.DEFAULT);
        ...
        public JSONObject toJson() {
            ...
            try {
                ...
                // master key encryption
                object.put(MASTER_KEY_KEY, Base64.encode(encryptedMasterKey, Base64.DEFAULT));
                object.put(MASTER_KEY_IV_KEY, Base64.encode(masterKeyIV, Base64.DEFAULT));
