...
import org.fejoa.chunkstore.BoxHeader;
import org.fejoa.chunkstore.ChunkContainerRef;
import org.fejoa.chunkstore.ChunkPointer;
import org.fejoa.chunkstore.ChunkStore;
import org.fejoa.chunkstore.HashValue;
import org.fejoa.chunkstore.IChunkAccessor;
import org.fejoa.chunkstore.ICommitCallback;
import org.fejoa.chunkstore.IRepoChunkAccessors;
import org.fejoa.chunkstore.ProtocolBufferLight;
import org.fejoa.chunkstore.PutResult;
import org.fejoa.chunkstore.RepoAccessorsTransactionBase;
        ...
        return new ICommitCallback() {
            ...
            public String commitPointerToLog(ChunkContainerRef commitPointer) throws CryptoException {
                ...
                try {
                    ...
                    return android.util.Base64.encodeToString(protoBuffer.toByteArray(), Base64.DEFAULT);
                } catch (IOException e) {
                    e.printStackTrace();
            ...
            public ChunkContainerRef commitPointerFromLog(String logEntry) throws CryptoException {
                try {
                    ProtocolBufferLight protoBuffer = new ProtocolBufferLight(Base64.decode(logEntry, Base64.DEFAULT));
    ...
    public static ICommitCallback getSimpleCommitCallback() {
        return new ICommitCallback() {
            ...
            public ChunkContainerRef commitPointerFromLog(String logEntry) {
                byte[] logEntryBytes = Base64.decode(logEntry, Base64.DEFAULT);
                try {
