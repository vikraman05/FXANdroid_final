...
abstract public class SimpleJsonRemoteJob<T extends RemoteJob.Result> extends JsonRemoteJob<T> {
    ...
    private T handleResponse(String header, InputStream inputStream) throws IOException, JSONException {
    ...
    abstract protected T handleJson(JSONObject returnValue, InputStream binaryData) throws JSONException;
