...
public class AccessRequestJob extends SimpleJsonRemoteJob {
    ...
    static public class AuthJob extends SimpleJsonRemoteJob {
        ...
        public String getJsonHeader(JsonRPC jsonRPC) throws Exception {
            String authSignature = Base64.encodeToString(accessTokenContact.signAuthToken(authToken), 16);
            String entrySignature = Base64.encodeToString(accessTokenContact.getAccessEntrySignature(), 16);
