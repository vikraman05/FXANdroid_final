...
public class BranchInfo extends MovableStorageContainer {
    public class Location extends MovableStorage {
        ...
        public Location(IOStorageDir dir, String remoteId, AuthInfo authInfo) throws IOException, JSONException {
            this(dir, remoteId);
        ...
        public void setAuthInfo(AuthInfo authInfo) throws IOException, JSONException {
        ...
        public AuthInfo getAuthInfo(FejoaContext context) throws IOException, CryptoException, JSONException {
            if (authInfo != null)
                return authInfo;
    ...
    public Location addLocation(String remoteId, AuthInfo authInfo) throws IOException, CryptoException, JSONException {
