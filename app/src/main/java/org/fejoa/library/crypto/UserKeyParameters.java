...
public class UserKeyParameters {
    ...
    public UserKeyParameters(JSONObject object) throws JSONException {
        this.kdfParameters = new KDFParameters(object.getJSONObject(KDF_PARAMETERS_KEY));
        this.userKeySalt = Base64.decode(object.getString(SUBKEY_SALT_KEY), Base64.DEFAULT);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        object.put(SUBKEY_SALT_KEY, Base64.encode(userKeySalt, Base64.DEFAULT));
