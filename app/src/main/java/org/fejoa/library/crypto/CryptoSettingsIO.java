...
public class CryptoSettingsIO {
    ...
    static public void write(CryptoSettings.Symmetric settings, IOStorageDir dir) throws IOException {
        write(settings, dir, "");
    }
    ...
    static public void write(CryptoSettings.Symmetric settings, IOStorageDir dir, String keyPrefix) throws IOException {
    ...
    static public void write(CryptoSettings.Signature settings, IOStorageDir dir, String keyPrefix)
            throws IOException {
        write((CryptoSettings.KeyTypeSettings) settings, dir, keyPrefix);
        dir.writeString(key(keyPrefix, ALGORITHM_KEY), settings.algorithm);
    }

    static public void write(CryptoSettings.KeyTypeSettings keyTypeSettings, IOStorageDir dir, String keyPrefix)
            throws IOException {
    ...
    static public void read(CryptoSettings.Symmetric settings, IOStorageDir dir) throws IOException {
        read(settings, dir, "");
    }

    static public void read(CryptoSettings.Symmetric settings, IOStorageDir dir, String keyPrefix) throws IOException {
    ...
    static public void read(CryptoSettings.Signature settings, IOStorageDir dir, String keyPrefix)
            throws IOException {
        read((CryptoSettings.KeyTypeSettings) settings, dir, keyPrefix);
        settings.algorithm = dir.readString(key(keyPrefix, ALGORITHM_KEY));
    }

    static public void read(CryptoSettings.KeyTypeSettings keyTypeSettings, IOStorageDir dir, String keyPrefix)
            throws IOException {
