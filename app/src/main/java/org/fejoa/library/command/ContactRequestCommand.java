...
public class ContactRequestCommand {
    ...
    static String makeInfoCommand(ContactPrivate myself, Remote myServer,
        ...
        String base64SignKey = Base64.encodeToString(pubSignKey, 16);
        ...
        String base64PublicKey = Base64.encodeToString(publicKey, 16);
        ...
        String signature = Base64.encodeToString(myself.sign(signingKeyPair, hash.getBytes()), 16);
