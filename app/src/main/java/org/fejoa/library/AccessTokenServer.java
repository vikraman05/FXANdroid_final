...
import static org.fejoa.library.AccessToken.ACCESS_VERIFICATION_KEY_KEY;
import static org.fejoa.library.AccessToken.CONTACT_AUTH_KEY_SETTINGS_KEY;
import static org.fejoa.library.AccessToken.CONTACT_AUTH_PUBLIC_KEY_KEY;
import static org.fejoa.library.AccessToken.SIGNATURE_KEY_SETTINGS_KEY;
...
public class AccessTokenServer implements IStorageDirBundle {
    ...
    public AccessTokenServer(FejoaContext context, JSONObject jsonObject) throws Exception {
        ...
        byte[] rawKey = Hex.decodeHex(
                jsonObject.getString(CONTACT_AUTH_PUBLIC_KEY_KEY).toCharArray());
        ...
        rawKey = Hex.decodeHex(
                jsonObject.getString(ACCESS_VERIFICATION_KEY_KEY).toCharArray());
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jsonObject.put(CONTACT_AUTH_PUBLIC_KEY_KEY, Base64.encodeToString(
                contactAuthKey.getEncoded(), 16));
        jsonObject.put(AccessToken.CONTACT_AUTH_KEY_SETTINGS_JSON_KEY, JsonCryptoSettings.toJson(
                contactAuthKeySettings));
        jsonObject.put(ACCESS_VERIFICATION_KEY_KEY, Base64.encodeToString(
                accessSignatureKey.getEncoded(), 16));
